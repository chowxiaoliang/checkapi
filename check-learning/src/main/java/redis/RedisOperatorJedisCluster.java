...
//			jedisClusterNodes.add(new HostAndPort(ip, port));
			// 解析ip
			jedisClusterNodes.add(new HostAndPort(ip[0], port[0]));
			jedisClusterNodes.add(new HostAndPort(ip[1], port[1]));
			jedisClusterNodes.add(new HostAndPort(ip[2], port[2]));
			jedisClusterNodes.add(new HostAndPort(ip[3], port[3]));
			jedisClusterNodes.add(new HostAndPort(ip[4], port[4]));
			jedisClusterNodes.add(new HostAndPort(ip[5], port[5]));
